...
public class EmailService {
  ...
  @Autowired
     ...
     */
  @ServiceActivator()
  public MimeMessage  handle(BookOrder order) 
          throws MessagingException {
      
	  // Need to use your own recipient here
	  String recipientEmail = "cornerstonetechnologies@gmail.com";
	  String recipientName = "Dear Professor Bruen";
	  	return handle( recipientName, recipientEmail, order,null);
  
  		}
 
	    public MimeMessage  handle(
	            final String recipientName, final String recipientEmail, BookOrder order,Locale locale) 
	            throws MessagingException {
        ...
        message.setSubject("BookOrder Details");
