...
<%-- <form:form modelAttribute = "user1" method = "post" action="/postLogin.html" cssClass="form-signin">
  			<fieldset>
  			<h2 class="form-signup-heading">Signin</h2>
  			<label for = "userNameInput">UserName</label>
  			<form:input path = "credentials.userName" cssClass="form-control" placeholder = "userName">
  			</fieldset>
 --%>